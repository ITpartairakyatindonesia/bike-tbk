...
import type { GovernanceHeroSection } from "@/lib/types/sanity";
...
export function GovernanceHero({ hero, locale }: GovernanceHeroProps) {
  ...
  const backgroundImage = hero?.backgroundImage?.asset ? urlFor(hero.backgroundImage).url() : "/business-energy.jpg";
