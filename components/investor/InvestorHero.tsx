...
import type { InvestorHeroSection } from "@/lib/types/sanity";
...
export function InvestorHero({ hero, locale }: InvestorHeroProps) {
  const label = pickLocalized(hero?.label, locale);
