...
import type { SustainabilityHeroSection } from "@/lib/types/sanity";
...
export function SustainabilityHero({ hero, locale }: SustainabilityHeroProps) {
  ...
  const backgroundImage = hero?.backgroundImage?.asset ? urlFor(hero.backgroundImage).url() : "/business-finance.jpg";
