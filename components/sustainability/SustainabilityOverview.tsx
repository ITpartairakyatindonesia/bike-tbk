...
import type { SustainabilityOverviewSection } from "@/lib/types/sanity";
...
export function SustainabilityOverview({ overview, locale }: SustainabilityOverviewProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {imageUrl && (
            <div className="rounded-2xl overflow-hidden shadow-card">
              <img
                src={imageUrl}
                alt={heading || "Sustainability overview"}
